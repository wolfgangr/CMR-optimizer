...
my $proj_ortho_template = '+proj=ortho +lat_0=%f +lon_0=%f +ellps=WGS84 +units=m +no_defs +type=crs';
...
my $proj_ortho_1st_est = sprintf $proj_ortho_template, @estimates;
print $proj_ortho_1st_est, "\n";

my $cs_1st_est = Geo::LibProj::cs2cs->new($CRS_lat_lon => $proj_ortho_1st_est);
...
my $proj_pipeline = $proj_ortho_template;
